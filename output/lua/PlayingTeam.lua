...
PlayingTeam.kStartingResUnits = 100
...
function PlayingTeam:Initialize(teamName, teamNumber)
    ...
    self.playingTeamResources = self.kStartingResUnits

end

function PlayingTeam:AddResourcesToTeam(amount, team)
    team.teamResourcePool = team.teamResourcePool + amount
end
...
//TODO: This is not satisfactory round win conditions :(
function PlayingTeam:GetHasTeamLostRound()
