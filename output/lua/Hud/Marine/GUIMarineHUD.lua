...
GUIMarineHUD.kRoundScoresTexture = "ui/topbar.dds"
...
function GUIMarineHUD:Initialize()
    ...
    self.roundscores = GUIManager:CreateGraphicItem()
    self.roundscores:SetAnchor(GUIItem.Middle, GUIItem.Top)
    self.roundscores:SetTexture(self.kRoundScoresTexture)
    self.roundscores:SetTexturePixelCoordinates(unpack(texCoord))
    self.roundscores:SetSize(texSize)
    self.roundscores:SetPosition(texPos)
    ...
    self.nanoshieldText:SetText("YOU ARE THE VIP")
...
self.scanLeft:SetTexturePixelCoordinates(GUIUnpackCoords(GUIMarineHUD.kScanLineTextureCoords))
    ...
    self.marineScore = self:CreateAnimatedTextItem()
    self.marineScore:SetFontName(Fonts.kAgencyFB_Medium)
    self.marineScore:SetAnchor(GUIItem.Middle, GUIItem.Center)
    self.marineScore:SetTextAlignmentX(GUIItem.Align_Center)
    self.marineScore:SetTextAlignmentY(GUIItem.Align_Center)
    self.marineScore:SetPosition(GUIScale(Vector(-130, -8, 0)))
    self.marineScore:SetColor(Color(1, 1, 1, 1))
    ...
    self.alienScore:SetTextAlignmentX(GUIItem.Align_Center)
    self.alienScore:SetTextAlignmentY(GUIItem.Align_Center)
    self.alienScore:SetPosition(GUIScale(Vector(130, -8, 0)))
    self.alienScore:SetColor(Color(1, 1, 1, 1))
    GUIMakeFontScale(self.alienScore)
    self.alienScore:AddAsChildTo(self.roundscores)
